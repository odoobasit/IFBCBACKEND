...
public class CandidatesController : ControllerBase
{
    ...
    // GET: api/FormData
    [HttpGet]
    public async Task<ActionResult<IEnumerable<Candidates>>> GetFormData()
    {
    ...
    // GET: api/FormData/5
    [HttpGet("{id}")]
    public async Task<ActionResult<Candidates>> GetFormData(int id)
    {
        var formData = await _context.Candidates.FindAsync(id);
    ...
    private void SendEmail(string body, string email, string name)
    {
        ...
        const string fromPassword = "ubge cloc shaq wdga";
        const string subject = "Thank you for applying as a candidate!";
    ...
    public static string GenerateHtmlTable(Candidates formData)
    {
        var properties = typeof(Candidates).GetProperties();
        ...
        foreach (var prop in properties)
        {
            ...
            if (propName != "DocId" && propName != "DocDate" && propName != "UpdateDate" && propName != "isArchive" && propName != "PipelineStep" && propName != "AgentUserId" && propName != "CategoryRating" && propName != "Status")
            {
                htmlBuilder.Append($@"
                <table
    ...
    // POST: api/FormData
    [HttpPost]
    public async Task<ActionResult<Candidates>> PostFormData(Candidates formData)
    {
        _context.Candidates.Add(formData);
...
Email us at <a href=""mailto:info@ifbc.co"">info@ifbc.co</a><br/>
    ...
    // PUT: api/FormData/5
    [HttpPut("{id}")]
    public async Task<IActionResult> PutFormData(int id, Candidates formData)
    {
    ...
    public async Task<IActionResult> DeleteFormData(int id)
    {
        ...
        _context.Candidates.Remove(formData);
        await _context.SaveChangesAsync();
